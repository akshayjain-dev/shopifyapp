...
return [
    ...
    */
    ...
    'api_key' => env('SHOPIFY_API_KEY', '2c00498021b0838830faeea664995079'),
    ...
    */
    ...
    'api_secret' => env('SHOPIFY_API_SECRET', 'f6d512d1c63bad51d0a6e31cd4c3e797'),
   ...
   'api_scopes' => env('SHOPIFY_API_SCOPES', 'read_orders,write_orders,read_inventory,read_discounts,read_customers,read_products'),
