...
this.updateSelectParent = function () {
  var url = $('.card-header').data('prefixurl');
  axios.get('/'+url+'/menu/element/get-parents?menu=' + document.getElementById("menu").value).then(function (response) {
...
__webpack_require__(/*! C:\xampp\htdocs\worldpay-coreui\resources\js\coreui\menu-create.js */"./resources/js/coreui/menu-create.js");
module.exports = __webpack_require__(/*! C:\xampp\htdocs\worldpay-coreui\resources\sass\style.scss */"./resources/sass/style.scss");
